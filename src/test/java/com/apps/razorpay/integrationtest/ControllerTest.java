...
class ControllerTest {
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM razorpay.Trips");
    jdbcTemplate.execute("DELETE FROM razorpay.Person");
     jdbcTemplate.execute("DELETE FROM razorpay.PersonFriends");
     jdbcTemplate.execute("DELETE FROM razorpay.PersonTrip");
